...
const KeyValueFormEditor: React.FC<KeyValueFormEditorProps> = ({
    ...
    const getFiltererdItemsFormValues = (items: KeyValueItem[])=>
    items
        .filter(
        ...
        //now we will apply debouncing logic
        ...
        const saveIfChanged = useCallback((items: KeyValueItem[]) => {
            const filtered = getFiltererdItemsFormValues(items)
        ...
        const debouncedInvokeRef = useRef<((items: KeyValueItem[]) => void) | null>(
            null
        );
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormControl>
                                            ...
                                            className='bg-transparent border-0 focus:ring-0 focus:border-0 placeholder:text-zinc-500'
