...
import { useGenerateWorkspaceInvite, useGetWorkspaceMembers } from "@/modules/invites/hooks/invite";
...
const InviteMember = () => {
  ...
  const {data: workspaceMembers, isLoading} = useGetWorkspaceMembers(selectedWorkspace?.id);
